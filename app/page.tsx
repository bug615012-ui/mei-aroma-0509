        ...
        {step === 0 && (
          <div className="animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="space-y-4 text-gray-600 bg-gray-50/50 p-6 md:p-8 rounded-[2rem] border border-gray-100/50 text-left text-sm md:text-base leading-relaxed">
              ...
              <p>若於服務前 24 小時內取消、臨時改期，或當日未到，因老師已為您保留專屬時段，將扣除時段保留費 $500，餘額可選擇保留為下次使用或申請退還。<strong className="text-green-700">預約保留費以 $500 為上限</strong>，若該次服務金額低於 $1,500，則以服務金額 30% 為預約保留費上限。</p>
